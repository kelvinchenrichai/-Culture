...
type RawDay = { gregorian: string; weekDay: string; lunar: { yearGanzhi?: string; monthName: string; dayName: string }; auspicious?: string[]; inauspicious?: string[]; solarTerm?: { name?: string }; clashDetail?: string; clashDirection?: string; auspiciousHours?: string[]; deityBirthday?: string[]; dayGanzhi?: { full?: string }; luckyDirection?: { 財神?: string; 喜神?: string }; pengTaboo?: string };
