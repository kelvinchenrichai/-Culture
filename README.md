...
[Phase 5 Data Completion Foundation 總覽](docs/phase-5-foundation.md)、[Phase 6 Bug Fixes & LINE Sharing 總覽](docs/phase-6-sharing-and-bugfixes.md)。
...
| SVG share card | DONE（Phase 6 前為死代碼，未接上任何畫面，本輪接上並補了下載成 PNG 的按鈕，見 phase-6） |
